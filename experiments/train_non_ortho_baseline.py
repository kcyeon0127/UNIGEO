"""Train baseline with non-orthogonal projectors + contrastive alignment."""
...
from unidoc.model import ManifoldAlignModel, LinearProjector
...
def main():
    parser = argparse.ArgumentParser(description="Train non-orthogonal projector baseline")
