"""Train concat-only baseline (no projectors, no contrastive loss)."""
...
from unidoc.model import ConcatBaselineModel
...
def main():
    parser = argparse.ArgumentParser(description="Train concat-only baseline")
    ...
    parser.add_argument("--z_dim", type=int, default=512, help="Hidden size after concat projector")
    parser.add_argument("--batch_size", type=int, default=8, help="Batch size")
    parser.add_argument("--epochs", type=int, default=10, help="Epochs")
    parser.add_argument("--lr", type=float, default=1e-4, help="Learning rate")
    parser.add_argument("--device", type=str, default="cuda", help="Device")
    parser.add_argument("--save_path", type=str, default="concat_baseline.pt", help="Checkpoint path")
